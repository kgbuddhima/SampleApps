...
namespace App1.Helpers
{
    public static class MonkeyHelper
    {
        ...
        public static Monkey.Monkey GetRandomMonkey()
        {
        ...
        public static ObservableCollection<Grouping<string, Monkey.Monkey>> MonkeysGrouped { get; set; }

        public static ObservableCollection<Monkey.Monkey> Monkeys { get; set; }

        static MonkeyHelper()
        {
            random = new Random();
            Monkeys = new ObservableCollection<Monkey.Monkey>();
            ...
            var sorted = from monkey in Monkeys
                         ...
                         select new Grouping<string, Monkey.Monkey>(monkeyGroup.Key, monkeyGroup);

            MonkeysGrouped = new ObservableCollection<Grouping<string, Monkey.Monkey>>(sorted);
