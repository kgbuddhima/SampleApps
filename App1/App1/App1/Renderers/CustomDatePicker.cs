...
namespace App1.Renderers
{
    public class CustomDatePicker:DatePicker
    {
        ...
        {
            get => (string)GetValue(EnterTextProperty);
            set => SetValue(EnterTextProperty, value);
        }

        public static readonly BindableProperty BorderColorProperty =
      BindableProperty.Create(nameof(BorderColor),
          typeof(Color), typeof(EntryWithBorder), Color.Gray);
        ...
        BindableProperty.Create(nameof(CornerRadius),
            typeof(double), typeof(EntryWithBorder));
        ...
        BindableProperty.Create(nameof(IsCurvedCornersEnabled),
            typeof(bool), typeof(EntryWithBorder), true);
